/*
Deployment script for qbq.EPCIS.Repository
...
GO
:setvar DatabaseName "qbq.EPCIS.Repository"
:setvar DefaultFilePrefix "qbq.EPCIS.Repository"
...
CREATE TABLE [Event].[EPCISEvent_DocumentHeader] (
    ...
    CONSTRAINT [PK_EPCISEvent_DocumentHeader] PRIMARY KEY CLUSTERED ([EPCISEventID] ASC, [DocumentHeaderID] ASC)
);
...
CREATE TABLE [Event].[EPCISEvent_Value_String] (
    ...
    CONSTRAINT [PK_EPCISEvent_Value_String] PRIMARY KEY CLUSTERED ([EPCISEvent_ValueID] ASC, [Value_StringID] ASC)
);
...
CREATE TABLE [Event].[EPCISEvent_Value_Hierarchy] (
    ...
    PRIMARY KEY CLUSTERED ([EPCISEvent_ValueID] ASC, [Parent_EPCISEvent_ValueID] ASC)
);
...
INSERT INTO #Vocabulary
     ...
     VALUES
		   ...
		   ----------------per default soll kein Mandant angelegt werden ------------------------------------------------
           --,
           --(1
           --,1
...
EXECUTE @RC = [Import].[usp_Import_MasterData_to_Queue] 
  ...
  --------------------per default keine Mandantendaten einspielen
